        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
          <div>
            ...
            <p className="mt-4 text-lg text-gray-600">
              We understand that every Eccomerce store is unique. If our
              standard packages don't quite fit your needs, we'll create a
              custom solution tailored specifically for your Eccomerce business.
            </p>
                ...
                <form className="mt-6 space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      name="requirements"
                      rows={4}
                      placeholder="Tell us about your Eccom business and what you need..."
                      className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 sm:text-sm"
                    />
                  </div>
